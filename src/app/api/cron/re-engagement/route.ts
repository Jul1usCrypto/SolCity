...
const TIERS: ReEngagementTier[] = [
  {
    ...
    body: (login) => `Hey @${login}, your building in SolCity is waiting. Come check in!`,
  ...
  },
  {
    ...
    html: (login, extraInfo) => `
      ...
      <p style="color: #f0f0f0;">New developers have joined SolCity since your last visit, @${login}.</p>
      ${extraInfo}
  ...
  },
  {
    ...
    html: (login, extraInfo) => `
      ...
      ${extraInfo}
      ${buildButton("Visit SolCity", `${BASE_URL}/?user=${login}`)}
    `,
  },
];
