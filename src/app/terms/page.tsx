...
export const metadata: Metadata = {
  title: "Terms of Service - SolCity",
  description: "Terms of Service for SolCity.",
};
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="mt-8 flex flex-col gap-5">
          <Section n={1} title="The Service">
            <p>
              SolCity is a web application that visualizes GitHub profiles as 3D
              buildings in a virtual city. By using SolCity, you agree to these
              terms.
            </p>
          </Section>
          ...
          <Section n={3} title="User Conduct">
            ...
            <ul className="mt-1 flex flex-col gap-1">
              ...
              <Li>Scrape or collect data from SolCity without permission</Li>
          ...
          <Section n={4} title="Intellectual Property">
            <p>
              SolCity, its code, design, and branding are owned by Samuel
          ...
          <Section n={5} title="Purchases & Shop">
            <p>
              SolCity offers optional cosmetic items for purchase. All purchases
          ...
          <Section n={6} title="Disclaimer of Warranties">
            <p>
              SolCity is provided &quot;as is&quot; and &quot;as
          ...
          <Section n={7} title="Limitation of Liability">
            <p>
              To the maximum extent permitted by law, Samuel Rizzon and SolCity
          ...
          <Section n={8} title="Third-Party Token">
            <p>
              ...
              created by the community, not by SolCity or Samuel Rizzon. We do
          ...
          <Section n={9} title="Changes to Terms">
            <p>
              We may update these terms at any time. Continued use of SolCity
