...
export function sendWelcomeNotification(devId: number, login: string, rank?: number) {
  ...
  sendNotificationAsync({
    ...
    title: `Welcome to SolCity, @${login}!`,
    body: `Your building is live in SolCity. ${rankText} Check in daily to grow your streak and unlock items.`,
    html: `
      <p style="color: #f0f0f0; font-size: 16px;">Your building is live in SolCity! ${rankText}</p>
